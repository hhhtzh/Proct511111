...
data = Data("txt_pmlb", "datasets/pmlb/train/612_fri_c1_1000_5.txt", ["x0", "x1", "x2", "x3", "x4", "y"])
...
equ_pd.to_csv(r"result/pmlb_612_fri_c1_1000_5_equ.csv", sep=',', mode="a")
time_pd.to_csv(r"result/pmlb_612_fri_c1_1000_5_equ.csv", sep=',', mode="a")
