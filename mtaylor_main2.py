...
data = Data("txt_pmlb", "datasets/feynman/train/feynman-i.18.12.txt", ["x0", "x1", "x2",  "y"])
...
equ_pd.to_csv(r"result/feynman-i.18.12_equ.csv", sep=',', mode="a")
time_pd.to_csv(r"result/feynman-i.18.12_equ.csv", sep=',', mode="a")
