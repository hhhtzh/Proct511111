...
argparser.add_argument("--trainset", type=str, default="datasets/pmlb/pmlb_txt/597_fri_c2_500_5.txt")
argparser.add_argument("--varset", type=str, default="datasets/pmlb/pmlb_csv/597_fri_c2_500_5.csv")
