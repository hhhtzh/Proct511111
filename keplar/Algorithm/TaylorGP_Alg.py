...
# =======
            ...
            population.target_pop_list = list(
                itertools.chain.from_iterable(population.target_pop_list))
            ...
            fitness = [
                program.raw_fitness_ for program in population.target_pop_list]
            ...
            fitness_ = [
                program.fitness_ for program in population.target_pop_list]
            ...
            if self._metric.greater_is_better:
                ...
                best_program_fitness_ = population.target_pop_list[np.argmax(
                    fitness_)]
            else:
                best_program = population.target_pop_list[np.argmin(fitness)]
                best_program_fitness_ = population.target_pop_list[np.argmin(
                    fitness_)]
                self.best_fit = best_program.fitness_
