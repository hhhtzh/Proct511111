...
data = Data("txt_pmlb", "datasets/feynman/train/feynman-i.14.4.txt", ["x0", "x1", "y"])
...
equ_pd.to_csv(r"result/feynman-i.14.4_equ.csv", sep=',', mode="a")
time_pd.to_csv(r"result/feynman-i.14.4_time.csv", sep=',', mode="a")
