...
data = Data("txt_pmlb", "datasets/feynman/train/feynman-bonus.18.txt", ["x0", "x1", "x2","y"])
...
equ_pd.to_csv(r"result/feynman-bonus.18_equ.csv", sep=',', mode="a")
time_pd.to_csv(r"result/feynman-bonus.18_time.csv", sep=',', mode="a")
