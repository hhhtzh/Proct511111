...
data = Data("txt_pmlb", "datasets/feynman/val/feynman-ii.15.4.txt", ["x0", "x1", "x2", "y"])
...
# print(npx)
fit_list = []
with open('/home/tzh/PycharmProjects/pythonProjectAR5/zjw_result/feynman-ii.15.4_equ.csv', 'rt') as csvfile:
...
fit_pd.to_csv(r"/home/tzh/PycharmProjects/pythonProjectAR5/zjw_result/feynman-ii.15.4_fit.csv", sep=',', mode="a")
