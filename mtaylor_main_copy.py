...
# data = Data("GGG", args.dataset, ["x0", "x1", "y"])
...
time_list = []
equ_list = []
mt = MTaylorGPAlg(1000, args.dataset, population=pop, NewSparseRegressionFlag=True)
...
time_pd.to_csv(r"zjw_result_new/" + fileName_whitout_ext + "_time.csv", sep=',', mode="a")
equ_pd.to_csv(r"zjw_result_new/" + fileName_whitout_ext + "_equ.csv", sep=',', mode="a")
