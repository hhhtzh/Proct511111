...
data = Data("txt_pmlb", "datasets/feynman/val/feynman-i.12.5.txt", ["x0", "x1", "y"])
...
# print(npx)
fit_list = []
with open('result/feynman-i.12.5_equ.csv', 'rt') as csvfile:
...
fit_pd.to_csv(r"result/feynman-i.12.5_fit.csv", sep=',', mode="a")
